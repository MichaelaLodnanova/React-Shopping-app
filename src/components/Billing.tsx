import { Card, Container, CardFooter, CardBody, Heading, CardHeader, SimpleGrid, GridItem, FormControl, FormLabel, Input, Flex, Button, Box, FormErrorMessage, Select } from '@chakra-ui/react'
                        ...
                        <SimpleGrid>
                            <GridItem paddingY='2'>
                                <Flex display="flex">
                                    ...
                                    <FormControl flex={2} textAlign='center' isInvalid={errors.name_sruname != undefined ? true : undefined}>
                                        <Input {...register("name_sruname")}></Input>
                                        <FormErrorMessage fontSize="sm" color="red">{errors.name_sruname?.message}</FormErrorMessage>
                                    </FormControl>
                                    <Box flex={1}></Box>
                                </Flex>
                            </GridItem>
                            <GridItem paddingY='2'>
                                <Flex display="flex">
                                    ...
                                    <FormControl flex={2} textAlign='center' isInvalid={errors.email != undefined ? true : undefined}>
                                        <Input {...register("email")}></Input>
                                        <FormErrorMessage fontSize="sm" color="red">{errors.email?.message}</FormErrorMessage>
                                    </FormControl>
                                    <Box flex={1}></Box>
                                </Flex>
                            </GridItem>
                            <GridItem paddingY='2'>
                                <Flex display="flex">
                                    ...
                                    <FormControl flex={2} textAlign='center' isInvalid={errors.phone != undefined ? true : undefined}>
                                        <Input {...register("phone")}></Input>
                                        <FormErrorMessage fontSize="sm" color="red">{errors.phone?.message}</FormErrorMessage>
                                    </FormControl>
                                    <Box flex={1}></Box>
                                </Flex>
                            </GridItem>
