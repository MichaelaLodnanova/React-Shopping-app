  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <SimpleGrid columns={2} columnGap={3} rowGap={6} w="full">
        <GridItem colSpan={1}>
          <FormControl
            isInvalid={errors.cardNumber != undefined ? true : undefined}
          >
          ...
          <Flex gap="0.5rem">
            <FormControl
              isInvalid={errors.expirationDate != undefined ? true : undefined}
            >
        ...
        <GridItem colSpan={1}>
          <FormControl
            isInvalid={errors.holderName != undefined ? true : undefined}
          >
